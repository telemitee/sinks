...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8081783857:AAFmOHC2xav6qnR6Co07cnnru-0-lWqsbaI")
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1003080227771"))

#OWNER ID --⚠️ REQUIRED--
OWNER_ID = int(os.environ.get("OWNER_ID", "8194215458"))
