...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7859871122:AAFNZJs8cQv1lJfUpP-pt0lsUhqB0dHKtaU")
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1001993981315"))
...
SUPPORT_GROUP = os.environ.get("SUPPORT_GROUP", "-1002186197570")
